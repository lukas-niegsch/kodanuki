...
class NinjaTarget(Target):
	...
	def execute(self, args):
		...
		writer.variable('flags', '-O2 -std=c++23 -Wall -Wextra -Werror -Wpedantic -g -fconcepts-diagnostics-depth=10')
		writer.newline()
...
class SphinxTarget(Target):
	...
	def execute(self, args):
		...
		subprocess.call(f'make -C {args.src_dir}/assets/sphinx html', shell = True)
